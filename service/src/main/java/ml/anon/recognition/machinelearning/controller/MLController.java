...
public class MLController {
    ...
    @RequestMapping(value = "/ml/get/evaluation/reset/", method = RequestMethod.GET)
    public EvaluationData resetEvalData() {
        configurationRepository.save(new Configuration(new Date()));
